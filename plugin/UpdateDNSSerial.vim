...
function! UpdateDNSSerialZone()
	...
	let numberOfLine = search('\(19\|20\|21\)\d\d\(0[1-9]\|1[012]\)\(0[1-9]\|[12][0-9]\|3[01]\)\d\d.*[sS]erial.*')
	if numberOfLine == 0
		...
		let serialZone=strpart(line, match(line,'\(19\|20\|21\)\d\d\(0[1-9]\|1[012]\)\(0[1-9]\|[12][0-9]\|3[01]\)'),match(line,";")-1-match(line,'\(19\|20\|21\)\d\d\(0[1-9]\|1[012]\)\(0[1-9]\|[12][0-9]\|3[01]\)'))
